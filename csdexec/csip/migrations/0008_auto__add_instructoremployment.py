...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstructorEmployment'
        db.create_table('csip_instructoremployment', (
            ...
            ('job_desc', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('csip', ['InstructorEmployment'])


    def backwards(self, orm):
        # Deleting model 'InstructorEmployment'
        db.delete_table('csip_instructoremployment')
