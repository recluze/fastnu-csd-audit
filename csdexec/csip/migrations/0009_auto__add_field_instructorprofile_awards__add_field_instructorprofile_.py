...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstructorProfile.awards'
        db.add_column('csip_instructorprofile', 'awards',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'InstructorProfile.memberships'
        db.add_column('csip_instructorprofile', 'memberships',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstructorProfile.awards'
        db.delete_column('csip_instructorprofile', 'awards')

        # Deleting field 'InstructorProfile.memberships'
        db.delete_column('csip_instructorprofile', 'memberships')
