...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstructorOtherActivity'
        db.create_table('csip_instructorotheractivity', (
        ...
        db.send_create_signal('csip', ['InstructorOtherActivity'])


    def backwards(self, orm):
        # Deleting model 'InstructorOtherActivity'
        db.delete_table('csip_instructorotheractivity')
