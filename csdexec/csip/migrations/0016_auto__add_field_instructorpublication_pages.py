...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstructorPublication.pages'
        db.add_column('csip_instructorpublication', 'pages',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstructorPublication.pages'
        db.delete_column('csip_instructorpublication', 'pages')
