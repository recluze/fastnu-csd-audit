...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstructorEducation'
        db.create_table('csip_instructoreducation', (
            ...
            ('grade', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
        ))
        db.send_create_signal('csip', ['InstructorEducation'])

        # Adding field 'InstructorProfile.gross_pay'
        db.add_column('csip_instructorprofile', 'gross_pay',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'InstructorEducation'
        db.delete_table('csip_instructoreducation')

        # Deleting field 'InstructorProfile.gross_pay'
        db.delete_column('csip_instructorprofile', 'gross_pay')
