...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstructorConsultancy.date'
        db.alter_column('csip_instructorconsultancy', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'InstructorConsultancy.date'
        db.alter_column('csip_instructorconsultancy', 'date', self.gf('django.db.models.fields.TextField')())
