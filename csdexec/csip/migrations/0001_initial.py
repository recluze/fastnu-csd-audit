...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('csip_instructorprofile', (
            ...
            ('current_position_appointment_date', self.gf('django.db.models.fields.DateField')()),
            ('joining_date', self.gf('django.db.models.fields.DateField')()),
            ('admin_responsibility', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('pay_grade', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('pay_step', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
        ))
        db.send_create_signal('csip', ['InstructorProfile'])


    def backwards(self, orm):
        # Deleting model 'InstructorProfile'
        db.delete_table('csip_instructorprofile')
