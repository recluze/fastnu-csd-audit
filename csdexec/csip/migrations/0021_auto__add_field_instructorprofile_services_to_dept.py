...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstructorProfile.services_to_dept'
        db.add_column('csip_instructorprofile', 'services_to_dept',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstructorProfile.services_to_dept'
        db.delete_column('csip_instructorprofile', 'services_to_dept')
