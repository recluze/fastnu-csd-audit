...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstructorPublication.pub_type'
        db.alter_column('csip_instructorpublication', 'pub_type', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'InstructorPublication.status'
        db.alter_column('csip_instructorpublication', 'status', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'InstructorPublication.pub_type'
        db.alter_column('csip_instructorpublication', 'pub_type', self.gf('django.db.models.fields.CharField')(max_length=10))
