...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstructorEducation.grade'
        db.alter_column('csip_instructoreducation', 'grade', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'InstructorEducation.grade'
        db.alter_column('csip_instructoreducation', 'grade', self.gf('django.db.models.fields.CharField')(max_length=10))
