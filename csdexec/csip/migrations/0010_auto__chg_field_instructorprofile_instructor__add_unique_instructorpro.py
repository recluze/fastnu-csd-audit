...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstructorProfile.instructor'
        db.alter_column('csip_instructorprofile', 'instructor_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cscm.Instructor'], unique=True))
        # Adding unique constraint on 'InstructorProfile', fields ['instructor']
        db.create_unique('csip_instructorprofile', ['instructor_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'InstructorProfile', fields ['instructor']
        db.delete_unique('csip_instructorprofile', ['instructor_id'])


        # Changing field 'InstructorProfile.instructor'
        db.alter_column('csip_instructorprofile', 'instructor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cscm.Instructor']))
