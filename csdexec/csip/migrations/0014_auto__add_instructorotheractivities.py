...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstructorOtherActivities'
        db.create_table('csip_instructorotheractivities', (
        ...
        db.send_create_signal('csip', ['InstructorOtherActivities'])


    def backwards(self, orm):
        # Deleting model 'InstructorOtherActivities'
        db.delete_table('csip_instructorotheractivities')
    ...
    models = {
        ...
        'csip.instructorotheractivities': {
            'Meta': {'object_name': 'InstructorOtherActivities'},
            'date': ('django.db.models.fields.DateField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instructor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cscm.Instructor']"}),
