...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstructorEventParticpation'
        db.create_table('csip_instructoreventparticpation', (
        ...
        db.send_create_signal('csip', ['InstructorEventParticpation'])


    def backwards(self, orm):
        # Deleting model 'InstructorEventParticpation'
        db.delete_table('csip_instructoreventparticpation')
