...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StudentTheses'
        db.create_table('csip_studenttheses', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('instructor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cscm.Instructor'])),
            ('students', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('year', self.gf('django.db.models.fields.DateField')()),
            ('thesis_title', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('dates', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('supervision_period', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal('csip', ['StudentTheses'])


    def backwards(self, orm):
        # Deleting model 'StudentTheses'
        db.delete_table('csip_studenttheses')
