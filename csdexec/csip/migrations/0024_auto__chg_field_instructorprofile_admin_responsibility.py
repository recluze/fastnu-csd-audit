...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstructorProfile.admin_responsibility'
        db.alter_column('csip_instructorprofile', 'admin_responsibility', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'InstructorProfile.admin_responsibility'
        db.alter_column('csip_instructorprofile', 'admin_responsibility', self.gf('django.db.models.fields.CharField')(max_length=200))
