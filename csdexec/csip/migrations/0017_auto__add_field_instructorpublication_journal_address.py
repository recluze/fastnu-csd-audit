...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstructorPublication.journal_address'
        db.add_column('csip_instructorpublication', 'journal_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstructorPublication.journal_address'
        db.delete_column('csip_instructorpublication', 'journal_address')
    ...
    models = {
        ...
        'csip.instructorpublication': {
            ...
            'pages': ('django.db.models.fields.CharField', [], {'max_length': '5', 'blank': 'True'}),
