...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'InstructorPublication.publisher'
        db.alter_column('csip_instructorpublication', 'publisher', self.gf('django.db.models.fields.TextField')())

        # Changing field 'InstructorPublication.title'
        db.alter_column('csip_instructorpublication', 'title', self.gf('django.db.models.fields.TextField')())

        # Changing field 'InstructorPublication.journal'
        db.alter_column('csip_instructorpublication', 'journal', self.gf('django.db.models.fields.TextField')())

        # Changing field 'InstructorPublication.number'
        db.alter_column('csip_instructorpublication', 'number', self.gf('django.db.models.fields.TextField')())

        # Changing field 'InstructorPublication.hec_cat'
        db.alter_column('csip_instructorpublication', 'hec_cat', self.gf('django.db.models.fields.TextField')())

        # Changing field 'InstructorPublication.author_list'
        db.alter_column('csip_instructorpublication', 'author_list', self.gf('django.db.models.fields.TextField')())

        # Changing field 'InstructorPublication.volume'
        db.alter_column('csip_instructorpublication', 'volume', self.gf('django.db.models.fields.TextField')())
