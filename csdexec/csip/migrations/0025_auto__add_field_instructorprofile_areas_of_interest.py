...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstructorProfile.areas_of_interest'
        db.add_column('csip_instructorprofile', 'areas_of_interest',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstructorProfile.areas_of_interest'
        db.delete_column('csip_instructorprofile', 'areas_of_interest')
