...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstructorProfile.email'
        db.add_column('csip_instructorprofile', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='nam@nu.edu.pk', max_length=75),
                      keep_default=False)

        # Adding field 'InstructorProfile.contact_number'
        db.add_column('csip_instructorprofile', 'contact_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'InstructorProfile.contact_address'
        db.add_column('csip_instructorprofile', 'contact_address',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'InstructorProfile.statement_of_research'
        db.add_column('csip_instructorprofile', 'statement_of_research',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstructorProfile.email'
        db.delete_column('csip_instructorprofile', 'email')

        # Deleting field 'InstructorProfile.contact_number'
        db.delete_column('csip_instructorprofile', 'contact_number')

        # Deleting field 'InstructorProfile.contact_address'
        db.delete_column('csip_instructorprofile', 'contact_address')

        # Deleting field 'InstructorProfile.statement_of_research'
        db.delete_column('csip_instructorprofile', 'statement_of_research')
    ...
    models = {
        ...
        'csip.instructoreducation': {
            ...
            'grade': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'csip.instructorprofile': {
            ...
            'admin_responsibility': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'areas_of_interest': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'awards': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'contact_address': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'contact_number': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            ...
            'services_to_dept': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'statement_of_research': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
        'csip.instructorpublication': {
            ...
            'pub_type': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
        ...
        'csip.studenttheses': {
            'Meta': {'object_name': 'StudentTheses'},
            'dates': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instructor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cscm.Instructor']"}),
            'students': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'supervision_period': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'thesis_title': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
