...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstructorConsultancy'
        db.create_table('csip_instructorconsultancy', (
        ...
        db.send_create_signal('csip', ['InstructorConsultancy'])


    def backwards(self, orm):
        # Deleting model 'InstructorConsultancy'
        db.delete_table('csip_instructorconsultancy')
