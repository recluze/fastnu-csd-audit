...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudentProject.active'
        db.add_column('cspj_studentproject', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StudentProject.active'
        db.delete_column('cspj_studentproject', 'active')
