...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudentProjectMilestoneCategory.milestone_type'
        db.add_column('cspj_studentprojectmilestonecategory', 'milestone_type',
                      self.gf('django.db.models.fields.CharField')(default='Document', max_length=100),
                      keep_default=False)

        # Deleting field 'StudentProjectMilestone.milestone_type'
        db.delete_column('cspj_studentprojectmilestone', 'milestone_type')


    def backwards(self, orm):
        # Deleting field 'StudentProjectMilestoneCategory.milestone_type'
        db.delete_column('cspj_studentprojectmilestonecategory', 'milestone_type')

        # Adding field 'StudentProjectMilestone.milestone_type'
        db.add_column('cspj_studentprojectmilestone', 'milestone_type',
                      self.gf('django.db.models.fields.CharField')(default='Document', max_length=100),
                      keep_default=False)
