...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StudentProjectMilestoneEvaluation'
        db.create_table('cspj_studentprojectmilestoneevaluation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('milestone', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cspj.StudentProjectMilestone'])),
            ('instructor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cscm.Instructor'])),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cspj.Student'])),
            ('evaluator_confidence', self.gf('django.db.models.fields.FloatField')()),
            ('problem_difficulty', self.gf('django.db.models.fields.FloatField')()),
            ('solution_strength', self.gf('django.db.models.fields.FloatField')()),
            ('execution', self.gf('django.db.models.fields.FloatField')()),
            ('issue_resolution', self.gf('django.db.models.fields.FloatField')()),
            ('presentation', self.gf('django.db.models.fields.FloatField')()),
            ('comments', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('cspj', ['StudentProjectMilestoneEvaluation'])


    def backwards(self, orm):
        # Deleting model 'StudentProjectMilestoneEvaluation'
        db.delete_table('cspj_studentprojectmilestoneevaluation')
