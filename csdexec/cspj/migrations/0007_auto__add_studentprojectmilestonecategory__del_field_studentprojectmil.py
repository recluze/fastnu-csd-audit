...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StudentProjectMilestoneCategory'
        db.create_table('cspj_studentprojectmilestonecategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('milestone_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('weight', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('milestone_deadline', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('project_type', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('cspj', ['StudentProjectMilestoneCategory'])

        # Deleting field 'StudentProjectMilestone.milestone_deadline'
        db.delete_column('cspj_studentprojectmilestone', 'milestone_deadline')

        # Deleting field 'StudentProjectMilestone.weight'
        db.delete_column('cspj_studentprojectmilestone', 'weight')

        # Deleting field 'StudentProjectMilestone.milestone_name'
        db.delete_column('cspj_studentprojectmilestone', 'milestone_name')

        # Adding field 'StudentProjectMilestone.milestone_category'
        db.add_column('cspj_studentprojectmilestone', 'milestone_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cspj.StudentProjectMilestoneCategory']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StudentProjectMilestoneCategory'
        db.delete_table('cspj_studentprojectmilestonecategory')

        # Adding field 'StudentProjectMilestone.milestone_deadline'
        db.add_column('cspj_studentprojectmilestone', 'milestone_deadline',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StudentProjectMilestone.weight'
        db.add_column('cspj_studentprojectmilestone', 'weight',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'StudentProjectMilestone.milestone_name'
        db.add_column('cspj_studentprojectmilestone', 'milestone_name',
                      self.gf('django.db.models.fields.CharField')(default='FYP-I', max_length=100),
                      keep_default=False)

        # Deleting field 'StudentProjectMilestone.milestone_category'
        db.delete_column('cspj_studentprojectmilestone', 'milestone_category_id')
    ...
    models = {
        ...
        'cspj.studentprojectmilestoneevaluation': {
            'Meta': {'object_name': 'StudentProjectMilestoneEvaluation'},
            'comments': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'evaluator_confidence': ('django.db.models.fields.FloatField', [], {}),
            'execution': ('django.db.models.fields.FloatField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instructor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cscm.Instructor']"}),
            'issue_resolution': ('django.db.models.fields.FloatField', [], {}),
            'milestone': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cspj.StudentProjectMilestone']"}),
            'presentation': ('django.db.models.fields.FloatField', [], {}),
            'problem_difficulty': ('django.db.models.fields.FloatField', [], {}),
            'solution_strength': ('django.db.models.fields.FloatField', [], {}),
