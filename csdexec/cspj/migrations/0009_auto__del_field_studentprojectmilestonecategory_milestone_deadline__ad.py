...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StudentProjectMilestoneCategory.milestone_deadline'
        db.delete_column('cspj_studentprojectmilestonecategory', 'milestone_deadline')
    ...
    def backwards(self, orm):
        # Adding field 'StudentProjectMilestoneCategory.milestone_deadline'
        db.add_column('cspj_studentprojectmilestonecategory', 'milestone_deadline',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)
