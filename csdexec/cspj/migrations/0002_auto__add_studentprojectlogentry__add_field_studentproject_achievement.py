...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StudentProjectLogEntry'
        db.create_table('cspj_studentprojectlogentry', (
            ...
            ('issues_discussed', self.gf('django.db.models.fields.TextField')()),
            ('issue_originator', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('recommendations', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('evaluation_instruments', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('score', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('cspj', ['StudentProjectLogEntry'])

        # Adding field 'StudentProject.achievements'
        db.add_column('cspj_studentproject', 'achievements',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StudentProjectLogEntry'
        db.delete_table('cspj_studentprojectlogentry')

        # Deleting field 'StudentProject.achievements'
        db.delete_column('cspj_studentproject', 'achievements')
