...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'StudentProjectMilestonr'
        db.delete_table('cspj_studentprojectmilestonr')

        # Adding model 'StudentProjectMilestone'
        db.create_table('cspj_studentprojectmilestone', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cspj.StudentProject'])),
            ('milestone_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('weight', self.gf('django.db.models.fields.IntegerField')()),
            ('milestone_type', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('milestone_deadline', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal('cspj', ['StudentProjectMilestone'])


    def backwards(self, orm):
        # Adding model 'StudentProjectMilestonr'
        db.create_table('cspj_studentprojectmilestonr', (
            ('milestone_deadline', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.IntegerField')()),
            ('milestone_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cspj.StudentProject'])),
        ...
        db.send_create_signal('cspj', ['StudentProjectMilestonr'])

        # Deleting model 'StudentProjectMilestone'
        db.delete_table('cspj_studentprojectmilestone')
