...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProgramObjective'
        db.create_table('cscm_programobjective', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('objectiveText', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('cscm', ['ProgramObjective'])


    def backwards(self, orm):
        # Deleting model 'ProgramObjective'
        db.delete_table('cscm_programobjective')
