...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProgramObjective.objectiveOrder'
        db.add_column('cscm_programobjective', 'objectiveOrder',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProgramObjective.objectiveOrder'
        db.delete_column('cscm_programobjective', 'objectiveOrder')
    ...
    models = {
        ...
        'cscm.programobjective': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'objectiveOrder': ('django.db.models.fields.IntegerField', [], {}),
