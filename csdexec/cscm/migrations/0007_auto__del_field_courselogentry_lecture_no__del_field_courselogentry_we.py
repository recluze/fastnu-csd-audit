...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CourseLogEntry.lecture_no'
        db.delete_column('cscm_courselogentry', 'lecture_no')

        # Deleting field 'CourseLogEntry.week_no'
        db.delete_column('cscm_courselogentry', 'week_no')


    def backwards(self, orm):
        # Adding field 'CourseLogEntry.lecture_no'
        db.add_column('cscm_courselogentry', 'lecture_no',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=2),
                      keep_default=False)

        # Adding field 'CourseLogEntry.week_no'
        db.add_column('cscm_courselogentry', 'week_no',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=2),
                      keep_default=False)
