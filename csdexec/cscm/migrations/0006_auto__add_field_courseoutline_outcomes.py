...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseOutline.outcomes'
        db.add_column('cscm_courseoutline', 'outcomes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseOutline.outcomes'
        db.delete_column('cscm_courseoutline', 'outcomes')
