...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field corresponding_program_objectives on 'CourseOutline'
        db.create_table('cscm_courseoutline_corresponding_program_objectives', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('courseoutline', models.ForeignKey(orm['cscm.courseoutline'], null=False)),
            ('programobjective', models.ForeignKey(orm['cscm.programobjective'], null=False))
        ))
        db.create_unique('cscm_courseoutline_corresponding_program_objectives', ['courseoutline_id', 'programobjective_id'])


    def backwards(self, orm):
        # Removing M2M table for field corresponding_program_objectives on 'CourseOutline'
        db.delete_table('cscm_courseoutline_corresponding_program_objectives')
    ...
    models = {
        ...
        'cscm.courseoutline': {
            ...
            'corresponding_program_objectives': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cscm.ProgramObjective']", 'symmetrical': 'False'}),
        ...
        'cscm.programobjective': {
            'Meta': {'object_name': 'ProgramObjective'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'objectiveText': ('django.db.models.fields.TextField', [], {})
        },
        'cscm.weekplan': {
